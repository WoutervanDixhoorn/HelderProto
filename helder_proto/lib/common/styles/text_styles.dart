...
abstract final class HelderText {
  ...
  static const TextStyle breadStyle = TextStyle(color: HelderColors.darkGrey, fontFamily: 'Rota', fontWeight: FontWeight.w300, fontSize: 16);
  ...
  static const TextStyle remissionStyle = TextStyle(color: HelderColors.purple, fontFamily: 'Rota', fontWeight: FontWeight.bold, fontSize: 16);
  static const TextStyle remissionStyleClickable = TextStyle(color: HelderColors.purple, fontFamily: 'Rota', fontWeight: FontWeight.bold, fontSize: 16, decoration: TextDecoration.underline);
